<template>
    <section>
        ...
        <b-modal :id="'sub-comp-list-add-subscription-'+unique" title="New Subscription Order"><order-form :company="props.company" :manual="this.props.manual" @submitted="orderCreated"></order-form></b-modal>
        ...
        computed: {
            ...
            details(){
                ...
                return (cmp && sub) ? [ _.zipObject(
                    ...
                    // [cp('company'),cp('domain'),vm.cClient(...ca),vm.cReferrer(...ca),'io','io']
                ) ] : [];
            }
        },
        methods: {
